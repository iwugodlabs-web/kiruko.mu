        ...
        <Box px="$3" pb="$6">
          ...
          <VStack space="md">
            ...
            <ProfileProgress
              ...
              jobData={jobData ? { job_title: jobData.job_title, employer_name: jobData.employer_name, work_start_time: jobData.work_start_time as any, work_end_time: jobData.work_end_time as any, work_days: jobData.work_days, reason_for_deduction: (jobData as any).reason_for_deduction } : null}
